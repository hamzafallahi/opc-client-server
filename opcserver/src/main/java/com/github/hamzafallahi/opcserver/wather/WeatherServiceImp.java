...
public class WeatherServiceImp implements WeatherService{
	...
	private final String apiKey = "59bd13613e0851d6c2544eb72f200621";

	public WeatherBean getWeather(String city, String country) {
		String url = String.format("http://api.openweathermap.org/data/2.5/weather?q=%s,%s&appid=%s&lang=TN", city, country, apiKey);
		RestTemplate restTemplate = new RestTemplate();
		return restTemplate.getForObject(url, WeatherBean.class);
	}
}
