		...
		try {
			...
			UsernameIdentityValidator identityValidator = new UsernameIdentityValidator(
					...
					authChallenge -> {
						...
						boolean hamzaOk = "hamza".equals(username) && "hamza".equals(password);

						return userOk || adminOk || hamzaOk;
					}
					);
			...
			OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
					...
					.setApplicationName(LocalizedText.english("Eclipse Milo OPC UA hamza Server"))
					.setEndpoints(endpointConfigurations)
					.setBuildInfo(
							new BuildInfo(
									"urn:com:github:hamzafallahi:secure-server",
									"hamzafallahi",
									"eclipse milo hamza server",
					...
					.setProductUri("urn:com:github:hamzafallahi:secure-server")
					.build();
