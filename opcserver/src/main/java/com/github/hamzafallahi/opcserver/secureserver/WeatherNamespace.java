...
public class WeatherNamespace extends ManagedNamespace {
	...
	@Autowired
	public WeatherNamespace(com.github.hamzafallahi.opcserver.secureserver.SecureServer secureServer) {
		super(secureServer.getServer(), "urn:com:github:hamzafallahi:secure-server:weather");
	...
	private void createWeatherElements(UaFolderNode rootFolder) {
		...
		//City Name
		{
			...
			cityChanger.getFilterChain().addLast(new com.github.hamzafallahi.opcserver.secureserver.RestrictedAccessFilter(identity -> {
		...
		//Forecast language
		{
			...
			languageChanger.getFilterChain().addLast(new com.github.hamzafallahi.opcserver.secureserver.RestrictedAccessFilter(identity -> {
